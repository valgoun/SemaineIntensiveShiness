...
////// Emissive:
                ...
                float3 node_9169 = (UNITY_LIGHTMODEL_AMBIENT.rgb*node_7379);
                float3 emissive = (_Emission*node_9169);
